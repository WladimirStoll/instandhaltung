...
public class KatalogMCView extends JDialog implements IKatalogMCBeobachter {

	private static final long serialVersionUID = 1L;
	private JPanel jContentPane = null;
	private JScrollPane jScrollPane = null;
	private JTable jTable = null;
	private KatalogMCController mCController;  //  @jve:decl-index=0:
	private AbstractTableModel abstractTableModel;
	private IKatalogMCModel iMCModel;  //  @jve:decl-index=0:
	 ...
	 * @param frame
	 */
	protected KatalogMCView(Frame frame, KatalogMCController mCController, IKatalogMCModel iMCModel) {
		super(frame);
		this.setModal(true);
...
//				getMCController().fensterIstGeschlossen();						
			...
			jTable.addMouseListener(new java.awt.event.MouseAdapter() {
				public void mouseClicked(java.awt.event.MouseEvent e) {
					if(e.getClickCount()==2){
						...
						KatalogBean bean = getiMCModel().getBeans().get(jTable.getSelectedRow());
						getMCController().setGewaehlteBean(bean);
						KatalogMCView.this.setVisible(false);
						getMCController().fensterIstGeschlossen();
					};
				}
			});
	...
	private KatalogMCController getMCController() {
		return mCController;
	}

	private void setMCController(
			KatalogMCController lieferantMCController) {
	...
	private IKatalogMCModel getiMCModel() {
		return iMCModel;
	}

	private void setiMCModel(IKatalogMCModel iMCModel) {
