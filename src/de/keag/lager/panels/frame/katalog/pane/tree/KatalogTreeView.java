...
public class KatalogTreeView extends TreeView implements ITreeBeobachter {
	 ...
	 * 
	 */
	protected KatalogTreeView(KatalogTreeController einlagerungTreePaneController) {
		super();
	...
	public JTree getJTree() {
		if (jTree == null) {
			...
			GenericNode root;
			try {
				root = new GenericNode(new KatalogModelKnotenBean(new KatalogBean()));
			...
			// Aussehen von JTree
			jTree.setCellRenderer(new KatalogTreeRenderer());
//			jTree = new JLagerTree();
...
//		if (root.getUserObject() instanceof KatalogModelKnotenBean){
//			//Anforderung wir im Tree gezeichnet.
//			TreePath angeklickterKnoten = null;
//			KatalogModelKnotenBean einlagerungModelKnotenBean = (KatalogModelKnotenBean)root.getUserObject();
//			for (ModelKnotenBean modelKnotenBeanKind : einlagerungModelKnotenBean.getKinderList()) {
//				if (modelKnotenBeanKind instanceof KatalogModelKnotenBean){
...
//	}
	...
	private class KatalogTreeRenderer extends DefaultTreeCellRenderer {
	    /**
		 * 
		 */
...
//					if (modelKnotenBean instanceof KatalogModelKnotenBean) {
//						KatalogModelKnotenBean einlagerungModelKnotenBean = (KatalogModelKnotenBean)modelKnotenBean;
...
//					;
					if (modelKnotenBean instanceof KatalogModelKnotenBean) {
						KatalogModelKnotenBean einlagerungPosModelKnotenBean = (KatalogModelKnotenBean)modelKnotenBean;
