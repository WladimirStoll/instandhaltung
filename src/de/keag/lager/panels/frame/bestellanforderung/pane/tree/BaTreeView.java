...
public class BaTreeView extends TreeView implements ITreeBeobachter {
	 ...
	 * 
	 */
	protected BaTreeView(BaTreeController baTreePaneController) {
		super();
	...
	public void zeichneDich(ModelKnotenBean modelKnotenBean, IModel iModel) {
		...
		if (modelKnotenBean != null) {
			if (modelKnotenBean.getSammelKnotenTypENUM() == ModelKnotenTyp.ANFORDERUNG) {
		...
		if (root.getUserObject() instanceof BaModelKnotenBean){
			//Anforderung wir im Tree gezeichnet.
			TreePath angeklickterKnoten = null;
			BaModelKnotenBean baModelKnotenBean = (BaModelKnotenBean)root.getUserObject();
	    ...
	    public Component getTreeCellRendererComponent(
			...
			if (node != null && node.getUserObject()!=null) {
				if (node.getUserObject() instanceof ModelKnotenBean) {
					...
					if (modelKnotenBean instanceof BaModelKnotenBean) {
						BaModelKnotenBean baModelKnotenBean = (BaModelKnotenBean)modelKnotenBean;
