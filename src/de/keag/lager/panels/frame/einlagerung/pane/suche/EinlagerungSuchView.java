...
public class EinlagerungSuchView extends SuchView {
	 ...
	 * 
	 */
	protected EinlagerungSuchView(EinlagerungSuchController einlagerungSuchPaneController, IModel iModel) {
		super();
		...
		if (jButtonSuchen == null) {
			...
			jButtonSuchen.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					EinlagerungPosSuchBean einlagerungPosSuchBean = new EinlagerungPosSuchBean();
					einlagerungPosSuchBean.setErstellungsDatumVon(getJPanelDatumVon().getDate());
					einlagerungPosSuchBean.setErstellungsDatumBis(getJPanelDatumBis().getDate());
					einlagerungPosSuchBean.setEinlagerungStatus((EinlagerungStatus)getJComboBoxStatus().getSelectedItem());
					getSuchController().suchen(einlagerungPosSuchBean);
				}
			});
		}
		...
		if (jPanelUnten == null) {
			...
			jPanelUnten.addMouseListener(new java.awt.event.MouseAdapter() {
				public void mouseClicked(java.awt.event.MouseEvent e) {
					EinlagerungSuchView.super.mouseClickedFehler(e, (JComboBox)e.getSource());
				}
			});
		}
		return jPanelUnten;
	...
	private JComboBox getJComboBoxFehler() {
		if (jComboBoxFehler == null) {
			...
			jComboBoxFehler.addMouseListener(new java.awt.event.MouseAdapter() {
				@Override
				public void mouseClicked(java.awt.event.MouseEvent e) {
					EinlagerungSuchView.this.mouseClickedFehler(e, getJComboBoxFehler());
				}
			});
		}
	...
	private JComboBox getJComboBoxStatus() {
		if (jComboBoxStatus == null) {
			EinlagerungStatus[] petEinlagerungen = {
					EinlagerungStatus.OFFEN,
					EinlagerungStatus.BESTAETIGT,
					EinlagerungStatus.GELOESCHT,
					EinlagerungStatus.FEHLERHAFT,
					EinlagerungStatus.ALLE
			};			
			jComboBoxStatus = new JComboBox(petEinlagerungen);
