...
CREATE TABLE `benutzer` (
  ...
  `copy_ba_email_empfaenger` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `benutzer` (`id`,`name`,`vorname`,`loginName`,`password`,`email`,`copy_ba_email_empfaenger`) VALUES 
 (0,'Schmidt','Eugen','eugen','1111','elektrowerkstatt@ke-ag.de',NULL),
 (14,'lager','lager','lager','pass','',NULL),
 (15,'Benutzer Absender','Vorname Absender','absender','abse','',NULL),
 (16,'Benutzer Empfänger','Vorname Empfänger','empfaenger','empf','',NULL),
 (17,'Wachter','Peter','peter','pete','schlosserei@ke-ag.de',NULL),
 (18,'Miftari','Saja','HeiligerMann','hagi','',NULL),
 (19,'Thurner','Dieter','Dieter','Diet','thurner@ke-ag.de',NULL);
...
INSERT INTO `sequence` (`id`,`tablefield`) VALUES 
 (100,'testtabelle'),
 (1079,'BestellAnforderungID'),
 (2115,'BestellAnforderungPosID');
