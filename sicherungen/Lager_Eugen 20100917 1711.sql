...
INSERT INTO `baugruppe` (`id`,`name`,`fk_baugruppe`,`erfassungsbenutzer`,`erfassungsdatum`,`aenderungsbenutzer`,`aenderungsdatum`) VALUES 
 ...
 (51,'baugr1.1.11',3,14,'2010-08-15 00:00:00',NULL,NULL),
...
INSERT INTO `bestellanforderungsposition` (`id`,`fk_bestellanforderung`,`fk_artikel`,`bestellmenge`,`liefertermin`,`status`,`fk_kostenstelle`,`fk_mengeneinheit`,`fk_katalog`,`lieferantenbestellnummer`,`katalogseite`,`katalogpreis`) VALUES 
 ...
 (2076,1048,21,6,19,'O',NULL,1,0,'','',0),
 ...
 (2153,1145,15,5,26,'O',NULL,1,0,'','',0),
...
INSERT INTO `entnahme` (`id`,`erstellungsdatum`,`status`,`fk_benutzer`) VALUES 
 (1,'0000-00-00 00:00:00','F',17),
 (2,'2010-01-02 00:00:00','A',18),
 (3,'2010-09-09 00:00:00','L',19),
 (4,'2010-10-10 00:00:00','O',17);
...
--
-- Definition of table `herstellerkatalog`
--

DROP TABLE IF EXISTS `herstellerkatalog`;
CREATE TABLE `herstellerkatalog` (
  `fk_herstellerlieferant` int(10) unsigned NOT NULL,
  `fk_katalog` int(10) unsigned NOT NULL,
  PRIMARY KEY (`fk_herstellerlieferant`,`fk_katalog`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `herstellerkatalog`
--

/*!40000 ALTER TABLE `herstellerkatalog` DISABLE KEYS */;
INSERT INTO `herstellerkatalog` (`fk_herstellerlieferant`,`fk_katalog`) VALUES 
 (1,3),
 (1,5),
 (5,2),
 (6,1);
/*!40000 ALTER TABLE `herstellerkatalog` ENABLE KEYS */;
...
INSERT INTO `herstellerlieferant` (`id`,`name`,`adresse_land`,`adresse_plz`,`adresse_stadt`,`adresse_strasse`,`telefon`,`fax`,`email`,`ansprechpartner`) VALUES 
 (1,'Siemens','DE','87435','Muenchen','Eichendorffweg ','0831 / 110','0831 / 11','email@email.de','Ansprechpartner von Siemens'),
 (2,'Moeller','DE','87435','Kempten','Eichendorffweg ','0831 / 110','0831 / 110 ','email@email1.de','Ansprechpartner von Hersteller 1'),
 ...
 (7,'Demag','DE','87436','Kempten (Ursulasried','Eichendorffweg 6','0831 / 110 6','0831 / 1103 65','email@emaidemag.de','Ansprechpartner von Demag');
...
INSERT INTO `sequence` (`id`,`tablefield`) VALUES 
 (100,'testtabelle'),
 (1152,'BestellAnforderungID'),
 (2161,'BestellAnforderungPosID'),
 (69,'BenutzerID'),
 (3,'agent007'),
 (157,'BaugruppeID'),
 (7,'EntnahmeID'),
 (10,'EntnahmenspositionPosID');
