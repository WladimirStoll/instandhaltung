...
INSERT INTO `bestellanforderung` (`id`,`erstellungsdatum`,`status`,`fk_herstellerLieferant`,`fk_benutzerAbsender`,`fk_benutzerAnnehmer`) VALUES 
 ...
 (5,'2010-03-05 00:00:00','L',1,NULL,NULL),
 ...
 (10,'2010-01-11 00:00:00','L',1,NULL,NULL),
 ...
 (34,'2010-01-13 00:00:00','L',1,NULL,NULL),
 ...
 (1028,'2010-03-05 00:00:00','F',NULL,NULL,NULL),
 (1029,'2010-03-05 00:00:00','L',NULL,NULL,NULL),
 (1030,'2010-03-05 00:00:00','L',NULL,NULL,NULL);
...
--
-- Definition of table `entnahmensposition`
--

DROP TABLE IF EXISTS `entnahmensposition`;
CREATE TABLE `entnahmensposition` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `entnahmensposition`
--

/*!40000 ALTER TABLE `entnahmensposition` DISABLE KEYS */;
/*!40000 ALTER TABLE `entnahmensposition` ENABLE KEYS */;
