...
--
-- Table structure for table `unterartikel`
--

DROP TABLE IF EXISTS `unterartikel`;
...
--
-- Dumping data for table `unterartikel`
--

LOCK TABLES `unterartikel` WRITE;
/*!40000 ALTER TABLE `unterartikel` DISABLE KEYS */;
INSERT INTO `unterartikel` VALUES (414,415,1),(416,415,1),(419,418,1);
/*!40000 ALTER TABLE `unterartikel` ENABLE KEYS */;
UNLOCK TABLES;
