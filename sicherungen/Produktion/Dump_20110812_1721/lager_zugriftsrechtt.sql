...
--
-- Table structure for table `zugriftsrechtt`
--
...
LOCK TABLES `zugriftsrechtt` WRITE;
/*!40000 ALTER TABLE `zugriftsrechtt` DISABLE KEYS */;
INSERT INTO `zugriftsrechtt` VALUES (2,'Abteilungsleiter'),(1,'Administrator'),(3,'Mitarbeiter');
